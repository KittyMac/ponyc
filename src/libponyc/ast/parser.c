...
DEF(prefix);
  PRINT_INLINE();
  TOKEN("prefix", TK_NOT, TK_ADDRESS, TK_ADDRESS_USIZE, TK_MINUS, TK_MINUS_TILDE, TK_MINUS_NEW,
...
DEF(nextprefix);
  PRINT_INLINE();
  TOKEN("prefix", TK_NOT, TK_ADDRESS, TK_ADDRESS_USIZE, TK_MINUS_NEW, TK_MINUS_TILDE_NEW,
    TK_DIGESTOF);
  MAP_ID(TK_MINUS_NEW, TK_UNARY_MINUS);
  MAP_ID(TK_MINUS_TILDE_NEW, TK_UNARY_MINUS_TILDE);
  RULE("expression", parampattern);
